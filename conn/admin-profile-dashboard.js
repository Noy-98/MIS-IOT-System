const firebaseConfig = {
  ...
  profilePicInput.addEventListener("change", function () {
      ...
      if (file) {
          const profilePicPath = `Admin Profile Pictures/${userId}_${file.name}`;
  ...
  document.getElementById("deleteProfilePic").addEventListener("click", () => {
      dbRef.once("value", (snapshot) => {
          ...
          if (userData.p_picture && !userData.p_picture.includes("profile_icon.png")) {
              ...
              fileRef.delete().then(() => {
                  database.ref(`UsersAccount/${userId}`).update({ p_picture: "https://firebasestorage.googleapis.com/v0/b/incuhatchtech-proj.appspot.com/o/Admin%20Profile%20Pictures%2Fprofile_icon.png?alt=media&token=ef1dbdae-df4d-4665-a76c-c19936527e91" });
                  document.getElementById("dp2").src = "https://firebasestorage.googleapis.com/v0/b/incuhatchtech-proj.appspot.com/o/Admin%20Profile%20Pictures%2Fprofile_icon.png?alt=media&token=ef1dbdae-df4d-4665-a76c-c19936527e91";
              }).catch(console.error);
          }
      });
  });
