const firebaseConfig = {
  ...
  adminForm.addEventListener("submit", async (e) => {
    ...
    const p_picture = "https://firebasestorage.googleapis.com/v0/b/incuhatchtech-proj.appspot.com/o/Admin%20Profile%20Pictures%2Fprofile_icon.png?alt=media&token=ef1dbdae-df4d-4665-a76c-c19936527e91";
    ...
    try {
      ...
      toggleLoading(false);
      showSuccess("Admin Added successful! Verification email sent.");
      adminForm.reset();
    } catch (error) {
