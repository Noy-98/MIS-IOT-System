const firebaseConfig = {
  ...
  profilePicInput.addEventListener("change", function () {
      ...
      if (file) {
          const profilePicPath = `Recruiter Profile Pictures/${userId}_${file.name}`;
  ...
  document.getElementById("deleteProfilePic").addEventListener("click", () => {
      dbRef.once("value", (snapshot) => {
          ...
          if (userData.p_picture && !userData.p_picture.includes("profile_icon.png")) {
              ...
              fileRef.delete().then(() => {
                  database.ref(`UsersAccount/${userId}`).update({ p_picture: "https://firebasestorage.googleapis.com/v0/b/incuhatchtech-proj.appspot.com/o/Recruiter%20Profile%20Pictures%2Fprofile_icon.png?alt=media&token=5c5fbbc4-e494-4a15-bbf0-1bba7dae6d2a" });
                  document.getElementById("dp2").src = "https://firebasestorage.googleapis.com/v0/b/incuhatchtech-proj.appspot.com/o/Recruiter%20Profile%20Pictures%2Fprofile_icon.png?alt=media&token=5c5fbbc4-e494-4a15-bbf0-1bba7dae6d2a";
              }).catch(console.error);
          }
      });
  });
